...
public class Cartao
{
    ...
    public void PrintIDData(PTEID_ID idData)
    {
        ...
        System.out.println("Name: " + idData.firstname + idData.name);
        System.out.println("...");
        ...
        try
        {
           ...
           // triesLeft = pteid.ChangePIN((byte)0x83, null, null);
            ...
            System.out.println("Number of certs found: " + certs.length);
                ...
                PTEID_Certif auth08 = certs[3];
                PTEID_Certif cartao02 = certs[5];
                PTEID_Certif estado = certs[6];
               ...
               // cert_byte = cartao02.certif;
                ...
                X509Certificate cert_root = (X509Certificate) fact.generateCertificate(is);
           ...
           /*String cert0_str =  certs[0].certifLabel;
            byte[] cert0 = certs[0].certif;
            CertificateFactory certFactory = CertificateFactory.getInstance("X.509");
            InputStream in = new ByteArrayInputStream(cert0);
            X509Certificate cert_gen = (X509Certificate)certFactory.generateCertificate(in);*/
            ...
            System.out.println("Exiting card...");
